...
export default function withDashboardHeader<P extends object>(
  ...
  return function WithDashboardHeader(componentProps: P) {
    return (
      <header className="flex h-10 justify-between shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
